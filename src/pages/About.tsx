  ...
  return (
    <main className="about">
      ...
      <p className="about__body">
        Comfy Sits crafts high-quality chairs, tables and dining sets — each piece reflecting a
      ...
      <a href={directLink()} target="_blank" rel="noopener noreferrer" className="about__cta">
        WhatsApp us ↗
      </a>
    </main>
  )
